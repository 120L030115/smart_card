<template>
    <div>
        <div class="i-layout-sider-logo" style="" :class="{ 'i-layout-sider-logo-dark': siderTheme === 'dark' }">
        ...
        <!--
        <div style="padding:10px;text-align:center" :class="{ 'i-layout-sider-logo-dark': siderTheme === 'dark' }">
            <transition name="fade-quick">
                <i-link to="/" v-show="!hideLogo">
                    <p style="color:#fff;font-size:18px" v-if="menuCollapse">智慧名片管理系统</p>
                    <p style="color:#fff;font-size:18px" v-else>智慧名片管理系统</p>
                </i-link>
            </transition>
        </div>-->
        <Menu ref="menu"
